...
protocol RMCharacterListViewViewModeDelegate: AnyObject {
...
final class RMCharacterListViewViewModel: NSObject {
    ...
    public weak var delegate: RMCharacterListViewViewModeDelegate?
        ...
        RMService.shared.execute(.listCharactersRequests, expecting: RMGetAllCharactersResponse.self) { [weak self] result in
            ...
            case .success(let responseModel):
                ...
                DispatchQueue.main.async {
                    self?.delegate?.didLoadIntitialCharacters()
                }
